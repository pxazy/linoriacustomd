...
local Library = {
    ...
    CustomFontBase64 = nil; -- Установи: Library.CustomFontBase64 = "BASE64HERE" до CreateWindow
...
function Library:CreateWindow(...)
    Library_LoadCustomFont(); -- загрузить кастомный шрифт если задан
    local Arguments = { ... }
