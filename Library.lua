...
local CurrentWidth = SliderInner.AbsoluteSize.X;
local X = math.ceil(Library:MapValue(Slider.Value, Slider.Min, Slider.Max, 0, CurrentWidth));
Fill.Size = UDim2.new(0, X, 1, 0);

HideBorderRight.Visible = not (X >= CurrentWidth or X <= 0);
end;
