...
Window.Sidebar = Sidebar;
    ...
    local Icons = {
        ["Combat"] = "rbxassetid://111214058727076",
        ["Visual"] = "rbxassetid://97830348678340",
        ["Misc"] = "rbxassetid://106321080652392",
    ...
    local TabButton = Library:Create('ImageButton', {
        ...
        Position = UDim2.new(0, 7, 0, (Library:GetTableCount(Window.Tabs) * 40) + 10);
        ZIndex = 3;
    ...
    local function AutoScroll(SFrame)
        local Layout = Library:Create('UIListLayout', {
            Padding = UDim.new(0, 8),
            Parent = SFrame
        })
        Layout:GetPropertyChangedSignal('AbsoluteContentSize'):Connect(function()
            SFrame.CanvasSize = UDim2.fromOffset(0, Layout.AbsoluteContentSize.Y + 20)
        end)
    end
    ...
    function Tab:ShowTab()
        ...
        TabButton.ImageColor3 = Library.AccentColor
    end

    function Tab:HideTab()
        TabFrame.Visible = false
        TabButton.ImageColor3 = Color3.new(1, 1, 1)
    end
