...
if FontBase64 ~= '' then
    local Success, Asset = pcall(function()
        return getcustomasset(base64decode(FontBase64), 'ProggyClean.ttf')
    end)

    if Success and Asset then
        CustomFontFace = Font.new(Asset, Enum.FontWeight.Regular, Enum.FontStyle.Normal)
    end
end
