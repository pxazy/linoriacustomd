        ...
        function Toggle:Display()
            ...
            if Toggle.Value then
                ToggleGradient.Color = ColorSequence.new({
                    ColorSequenceKeypoint.new(0, Library:GetLighterColor(Library.AccentColor)),
...
function Library:CreateWindow(...)
    ...
    Library:AddToRegistry(SideBarInner, {
        BackgroundColor3 = 'MainColor';
        BorderColor3 = 'OutlineColor';
    });
    ...
    local TabContainer = Library:Create('Frame', {
        BackgroundColor3 = Library.MainColor;
        BorderColor3 = Library.OutlineColor;
        Position = UDim2.new(0, 8 + SideBarWidth + 6, 0, 8);
        Size = UDim2.new(1, -16 - SideBarWidth - 6, 1, -16);
        ZIndex = 2;
        Parent = MainSectionInner;
    });
    ...
    function Window:AddTab(Name, IconId)
        ...
        local TabButton = Library:Create('Frame', {
            BackgroundColor3 = Library.BackgroundColor;
            BorderColor3 = Library.OutlineColor;
            Size = UDim2.new(0, SideBarWidth - 8, 0, SideBarWidth - 8);
            ZIndex = 4;
            Parent = SideBarInner;
        });
        ...
        if #SideBarInner:GetChildren() == 2 then
            Tab:ShowTab();
        end;
