...
local base64FontData = "ВАШ_BASE64_ИЗ_ФАЙЛА_MOMOCRAFT_TTF";
...
if getcustomasset and writefile and isfile and b64decode then
    ...
    if #fontData > 100 then
        if isfolder and makefolder and not isfolder("LibraryFonts") then 
            makefolder("LibraryFonts");
        end
        
        local ttfPath = "LibraryFonts/momocraft.ttf";
        local jsonPath = "LibraryFonts/momocraft.font";
        ...
        if isfile(ttfPath) and not isfile(jsonPath) then
            ...
            local fontJson = [[{"name": "MomoFont","faces":[{"name": "Regular","weight": 400,"style": "normal","assetId": "]] .. assetPath .. [["}]}]]
            writefile(jsonPath, fontJson);
        end
        
        if isfile(jsonPath) then
            CustomFontAsset = Font.new(getcustomasset(jsonPath));
        end
    end
end
