...
function Library:CreateLabel(Properties, IsHud)
    ...
    local function drawText(text)
        ...
        editImage:WritePixels(Vector2.new(0, 0), Vector2.new(512, 64), pixels)
    end

    if Properties.Text then
        drawText(Properties.Text)
    end
