...
function Library:RefreshKeybindFrame()
    ...
    local Y = Count * 16
    Library.KeybindFrame.Visible = Count > 0
    Library.KeybindFrame.Size = UDim2.new(0, math.max(X + 24, 130), 0, math.max(Y, 12) + 22)
end
...
function Library:CloseActiveColorPopup()
    if Library.ActiveColorPopup then
        Library.ActiveColorPopup:Close()
...
function Funcs:AddToggle(Idx, Info)
    ...
    local Lbl = Library:CreateLabel({
        ...
        Size = UDim2.new(1, -(BOX_SIZE + 60), 1, 0),
        Text = Info.Text,
        TextXAlignment = Enum.TextXAlignment.Left,
    ...
    local Clickable = Library:Create('Frame', { BackgroundTransparency = 1, Size = UDim2.new(1, -52, 1, 0), Parent = Row })
...
function Funcs:AddDropdown(Idx, Info)
    ...
    Library:AddToRegistry(List, { BackgroundColor3 = 'BackgroundColor', BorderColor3 = 'OutlineColor' })
    ...
    local function BuildList()
        ...
        for _, Val in next, Dropdown.Values do
            ...
            Library:AddToRegistry(Item, { TextColor3 = 'FontColor' })
...
function Funcs:AddColorPicker(Idx, Info)
    ...
    Library:AddToRegistry(Swatch, { BorderColor3 = 'OutlineColor' })

    local PopupHeight = Library.IsMobileMode and 172 or 150

    local Popup = Library:Create('Frame', {
        BackgroundColor3 = Library.MainColor,
        BorderColor3 = Library.OutlineColor,
        BorderSizePixel = 1,
        Size = UDim2.new(0, 170, 0, PopupHeight),
        Visible = false,
        ZIndex = 60,
        Parent = ScreenGui,
    })
    Library:AddToRegistry(Popup, { BackgroundColor3 = 'MainColor', BorderColor3 = 'OutlineColor' })
    ...
    Library:AddToRegistry(HexBox, { BackgroundColor3 = 'BackgroundColor', BorderColor3 = 'OutlineColor', TextColor3 = 'FontColor' })
    ...
    local function SetActive(Active)
        Swatch.BorderColor3 = Active and Library.AccentColor or Library.OutlineColor
        Library.RegistryMap[Swatch].Properties.BorderColor3 = Active and 'AccentColor' or 'OutlineColor'
    end

    function Self:Open()
        Library:CloseActiveColorPopup()
        Popup.Visible = true
        SetActive(true)
        Library.ActiveColorPopup = Self
    end

    function Self:Close()
        Popup.Visible = false
        SetActive(false)
        if Library.ActiveColorPopup == Self then Library.ActiveColorPopup = nil end
    end

    if not Library.IsMobileMode then
        ...
        Library:AddToRegistry(ContextMenu, { BackgroundColor3 = 'MainColor', BorderColor3 = 'OutlineColor' })

        local CopyOpt = Library:CreateLabel({
            Text = 'Copy',
        ...
        local PasteOpt = Library:CreateLabel({
            Text = 'Paste',
        ...
        CopyOpt.InputBegan:Connect(function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                Library.ColorClipboard = ColorPicker.Value
                ContextMenu.Visible = false
            end
        end)
        PasteOpt.InputBegan:Connect(function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                if Library.ColorClipboard then
                    Hue, Sat, Vib = Color3.toHSV(Library.ColorClipboard)
                    Refresh()
                    Library:AttemptSave()
                end
                ContextMenu.Visible = false
        ...
        Swatch.InputBegan:Connect(function(Input)
            ...
            if Input.UserInputType == Enum.UserInputType.MouseButton2 then
                ...
                ContextMenu.Position = UDim2.fromOffset(Pos.X, Pos.Y)
        ...
        Library:GiveSignal(InputService.InputBegan:Connect(function(Input)
            ...
            local Pos, Size = ContextMenu.AbsolutePosition, ContextMenu.AbsoluteSize
        ...
        Library:AddToRegistry(CopyBtn, { BackgroundColor3 = 'MainColor', BorderColor3 = 'OutlineColor', TextColor3 = 'FontColor' })
        ...
        Library:AddToRegistry(PasteBtn, { BackgroundColor3 = 'MainColor', BorderColor3 = 'OutlineColor', TextColor3 = 'FontColor' })
...
function Funcs:AddKeyPicker(Idx, Info)
    local KeyPicker = { Value = Info.Default, Toggled = false, Mode = Info.Mode or 'Toggle', Type = 'KeyPicker', SyncToggleState = Info.SyncToggleState or false, Callback = Info.Callback or function() end }
    local Groupbox = self
    ...
    local function SetActive(State)
        if State then
            ...
            Btn.BorderColor3 = Library.AccentColorDark
        ...
        Library:RemoveFromRegistry(Btn)
        if State then
            Library:AddToRegistry(Btn, {
                BackgroundColor3 = 'AccentColor',
                BorderColor3 = 'AccentColorDark',
                TextColor3 = function() return Color3.new(1, 1, 1) end,
            })
        else
            Library:AddToRegistry(Btn, { BackgroundColor3 = 'MainColor', BorderColor3 = 'OutlineColor', TextColor3 = 'FontColor' })
        end
    ...
    function KeyPicker:Update()
        ...
        Entry.Visible = not Info.NoUI
        SetActive(KeyPicker:GetState())
    ...
    function KeyPicker:OnClick(f) KeyPicker.Clicked = f end
...
function Library:CreateWindow(Config)
    ...
    local TitleLine = Library:Create('Frame', { BackgroundColor3 = Library.AccentColor, BorderSizePixel = 0, Position = UDim2.new(0, 8, 1, -1), Size = UDim2.new(1, -16, 0, 1), Parent = TitleBar })
    ...
    function Window:AddTab(Name)
        ...
        function Tab:AddGroupbox(Name, Side)
            ...
            local BoxOuter = Library:Create('Frame', { BackgroundColor3 = Library.BackgroundColor, BorderColor3 = Library.OutlineColor, BorderSizePixel = 1, Size = UDim2.new(1, 0, 0, 40), Parent = Parent })
            Library:AddToRegistry(BoxOuter, { BackgroundColor3 = 'BackgroundColor', BorderColor3 = 'OutlineColor' })
            local BoxLine = Library:Create('Frame', { BackgroundColor3 = Library.AccentColor, BorderSizePixel = 0, Size = UDim2.new(1, 0, 0, 2), Parent = BoxOuter })
            Library:AddToRegistry(BoxLine, { BackgroundColor3 = 'AccentColor' })
...
function Library:Toggle()
    ...
    if not Library.Toggled then Library:CloseActiveColorPopup() end
end
...
if IsMobileMode then
    ...
    local function MakeBtn(text, y)
        ...
        local Line = Library:Create('Frame', { BackgroundColor3 = Library.AccentColor, BorderSizePixel = 0, Size = UDim2.new(1, 0, 0, 2), Parent = Outer })
        Library:AddToRegistry(Line, { BackgroundColor3 = 'AccentColor' })
        local Btn = Library:Create('TextButton', {
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 1, 0),
            Font = Library.Font,
...
local ThemeManager = {} do
    ...
    ThemeManager.BuiltInThemes = {
        ...
        ['Grape'] = {
            FontColor = Color3.fromRGB(235, 235, 235),
            MainColor = Color3.fromRGB(34, 30, 40),
            BackgroundColor = Color3.fromRGB(24, 21, 29),
            AccentColor = Color3.fromRGB(140, 90, 255),
            OutlineColor = Color3.fromRGB(50, 45, 60),
        },
        ['Ocean'] = {
            FontColor = Color3.fromRGB(235, 235, 235),
            MainColor = Color3.fromRGB(22, 31, 34),
            BackgroundColor = Color3.fromRGB(14, 21, 23),
            AccentColor = Color3.fromRGB(0, 175, 205),
            OutlineColor = Color3.fromRGB(40, 55, 60),
        },
        ['Rose'] = {
            FontColor = Color3.fromRGB(235, 235, 235),
            MainColor = Color3.fromRGB(36, 25, 29),
            BackgroundColor = Color3.fromRGB(24, 17, 19),
            AccentColor = Color3.fromRGB(255, 75, 125),
            OutlineColor = Color3.fromRGB(55, 38, 42),
        },
        ['Forest'] = {
            FontColor = Color3.fromRGB(235, 235, 235),
            MainColor = Color3.fromRGB(24, 31, 24),
            BackgroundColor = Color3.fromRGB(16, 22, 16),
    ...
    function ThemeManager:ApplyToTab(tab)
        self:CreateThemeManager(tab)
        self:ApplyDefaultTheme()
    end

    function ThemeManager:ApplyToGroupbox(groupbox)
        local Fake = { AddLeftGroupbox = function() return groupbox end }
        self:CreateThemeManager(Fake)
        self:ApplyDefaultTheme()
    end
