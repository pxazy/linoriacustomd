...
function Library:CreateWindow(...)
    ...
    if Config.TitleImage and Config.TitleImage ~= 0 and Config.TitleImage ~= '' then
        WindowLabel = Library:Create('ImageLabel', {
            BackgroundTransparency = 1;
            Position = UDim2.new(0, 7, 0, 2);
            Size = Config.TitleImageSize or UDim2.new(0, 120, 0, 20);
            Image = 'rbxassetid://' .. tostring(Config.TitleImage);
            ZIndex = 1;
            Parent = Inner;
        });
    else
    ...
    function Window:SetWindowTitle(Title)
        if WindowLabel:IsA('TextLabel') then
