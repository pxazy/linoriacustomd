...
function Library:CreateConfigSection(Tab)
    ...
    MenuTab:AddLabel('Watermark Bg'):AddColorPicker('LibWatermarkBg', { Default=Library.MainColor, Title='Watermark Bg', Callback=function(v) Library:SetWatermarkBgColor(v) end })
