-- Исправленная библиотека для Delta Mode
-- Добавлено: возможность двигать меню, кнопки UI, темы, конфиг в настройках
...
-- ФИКС ДЛЯ ТЕЛЕФОНА: улучшенное перетаскивание с кнопкой
...
-- Функция для создания кнопок управления UI на телефоне
function Library:CreateMobileControls()
    ...
    btnClose.MouseButton1Click:Connect(function() 
        Library:Toggle()
        -- Скрываем кнопки если меню закрыто
    end)
