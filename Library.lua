    ...
    function Toggle:Display()
        ...
        if Toggle.Value then
            ToggleGradient.Color = ColorSequence.new({
                ...
                ColorSequenceKeypoint.new(1, Color3.new(targetColor.R / 1.3, targetColor.G / 1.3, targetColor.B / 1.3))
            });
